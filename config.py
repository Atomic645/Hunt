...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002346524606"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001957198007"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002164744560"))
...
try:
    ADMINS=[6376328008]
    for x in (os.environ.get("ADMINS", "6397757784 5350104697").split()):
        ADMINS.append(int(x))
except ValueError:
