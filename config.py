...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7829496763:AAFN-jRLBQ8v5JWpJ3sd1KmPw2B22xvq22M")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002191230661"))
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002063385964"))
...
try:
    ADMINS=[6376328008]
    for x in (os.environ.get("ADMINS", "6841494969 5350104697").split()):
        ADMINS.append(int(x))
except ValueError:
